...
<form method="POST" action="ex08.jsp">
    <table class="vertical">
        ...
        <tr>
            <th>버튼 간격</th>
            <td>
                <div>좌우 간격: <input type="range"></div>
                <br>
        ...
        <tr>
            <th>아이콘</th>
            <td><label><input type="radio">없음</label><label><input type="radio"><i
                    class="fa-solid fa-house"></i></label><label><input type="radio"><i class="fa-regular fa-image"></i></label><label><input
                    type="radio"><i class="fa-solid fa-location-dot"></i></label><label><input type="radio"><i
                    class="fa-brands fa-github"></i></label><label><input type="radio"><i
                    class="fa-solid fa-paperclip"></i></label></td>
        </tr>
        <tr>
            <th>테두리</th>
            <td>
