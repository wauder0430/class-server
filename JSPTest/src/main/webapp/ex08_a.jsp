    ...
    <table id="tbl" class="vertical">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="radio" name="icon" value="fa-solid fa-location-dot"> <i
        ...
        <tr>
            ...
            <td>
                ...
                <div id="borderbox">
                    <div>두께(px) : <input type="number" name="borderwidth" min="0" max="10" value="1"
                                         class="form-control sm inline right"></div>
                    ...
                    <div>
                        모서리(px) : <input type="number" name="borderradius" min="0" max="50" value="0"
                                         class="form-control sm inline right">
                    </div>
                </div>
            </td>
        </tr>
